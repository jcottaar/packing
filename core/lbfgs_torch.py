...
def lbfgs(
    ...
    A simple functional interface to L-BFGS optimization.

    Args:
        func: Callable that takes x (Tensor) and returns (cost, gradient) tuple.
              Both cost and gradient should be tensors.
        x0: Initial parameter tensor (will be modified in-place).
