...
def test_costs():
    ...
    costs_to_test = [pack_cost.CostDummy(), pack_cost.CollisionCostSeparation(use_max=False), pack_cost.CollisionCostSeparation(use_max=False, TEMP_use_kernel=True), 
